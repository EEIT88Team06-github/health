...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"  %>
<c:set var="subTitle" value="運動推薦" scope="session" />
		...
		<div class="container" style="height: 500px;width: 1500px;">
			...
			<div class="row">
				<div class="col-md-3 col-xs-3">
					<img src="${pageContext.servletContext.contextPath }/recommands/img/sport.jpg" 
				...
				<div class="col-md-9 col-xs-9" style="background:url(/health/images/bg01.jpg) repeat;" >
					...
					<div class="col-md-6 col-xs-6" style="text-align: center;">
						<div class="row">
							<img src='${pageContext.servletContext.contextPath}/getImage?id=${recommand.id}&type=sport' 
					...
					<div class="col-md-6 col-xs-6" >
						<div class="row" style="text-align: center">
							<span class="info">${recommand.name} / </span><span class="info">${recommand.sportType} </span>
							
						</div>
						<div class="row">
							<br/>
							<span class="info" style="font-size: 22px">知識說明：</span>
							<br />
							<br/>
							<span class="sport">${recommand.content} </span>
						</div>
					</div>
				</div>

			...
			<div id="TBE">
				<table id="TE1">
					<tbody>
						...
						<c:forEach var="cVar" items="${csAll}">
							<tr>
								<td><p>${cVar.publishtime}</p></td>
								<td><p>${cVar.subjects}</p></td>
								<td><p>${cVar.recommand}</p></td>
								<td><p>${cVar.replynum}</p></td>
								<td><p>${cVar.popularity}</p></td>
								<td><p>${cVar.subjectstatus}</p></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>

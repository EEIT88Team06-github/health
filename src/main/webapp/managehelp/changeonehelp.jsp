    ...
    <form action="<c:url value='/Manage/HelpInsert.do' />" method="POST">
		<table>
			<tr>
				...
				<td><input type="text" name="id" value="${update.id}"></td>
				<td>${error.id}</td>
			</tr>
			<tr>
...
<!-- 				<td><textarea id="textarea" rows="7" cols="50" name="answer" style="resize: none;"></textarea></td> -->
				<td><input type="text" name="answer" value="${update.answer}" style="height:145px; width:425px; text-align:left;"></td>				
				<td>${error.answer}</td>
			</tr>
			<tr>

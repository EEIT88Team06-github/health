...
public class GlobalService {
	...
	public static final String host = "192.168.152.129";
	public static final String USERID = "sa";
	public static final String PASSWORD = "passw0rd";
	public static final String SYSTEM_NAME = "HEALTH";
	public static final String JNDI_DB_NAME = "java:comp/env/jdbc/BookDataSQLver";
	public static final int IMAGE_FILENAME_LENGTH = 20;
	public static final String DB_URL = "jdbc:sqlserver://" + GlobalService.host + ":1433;databaseName=HEALTH" ;
	...
	public static void main(String[] args) throws Exception {
		String plainText = "123yyuuiioo";
		String encText = encryptString(plainText);
		System.out.println(encText);
		String decText = decryptString(KEY, encText);
